...
const eventHandler = (() => {
  ...
  const initialize = () => {
    ...
    domSelectors.newItemBtn.addEventListener(
      'click',
      displayController.showNewItemForm,
    );
    domSelectors.newListBtn.addEventListener(
      'click',
      displayController.showNewListForm,
    );

    domSelectors.newItemForm.addEventListener(
      'submit',
      itemsController.newItem,
    );
    domSelectors.newListForm.addEventListener(
      'submit',
      listsController.newList,
    );
    domSelectors.cancelNewItemBtn.addEventListener(
      'click',
      displayController.render,
    );
    domSelectors.cancelNewListBtn.addEventListener(
      'click',
      displayController.render,
    );
